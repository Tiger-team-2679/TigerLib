...
public class FieldsTable {
    ...
    public <T extends Enum<T>> Supplier<T> addEnum(
            String name,
            Class<T> enumClass,
            Supplier<T> valueSupplier,
            T defaultValue,
            CycleReceiverOptions... cycleReceiversOptions) {
        return new EnumField<T>(prefix + name, valueSupplier, enumClass, defaultValue, true, cycleReceiversOptions);
    }
    ...
    public <T extends Enum<T>> Supplier<T> addEnum(
            ...
            boolean asString,
            CycleReceiverOptions... cycleReceiversOptions) {
        return new EnumField<T>(prefix + name, valueSupplier, enumClass, defaultValue, asString, cycleReceiversOptions);
    }
